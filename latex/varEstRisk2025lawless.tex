...
\newcommand{\GHI}{1}
\newcommand{\KISPIIMM}{2}
\newcommand{\LEEDS}{3}
\newcommand{\IPSNEO}{4}
% \newcommand{\METAB}{5}

\author[\GHI]{Simon Boutry \textsuperscript{†}}
\author[\GHI]{Ali Saadat \textsuperscript{†}}
% \author[\METAB]{D. Sean Froese \textsuperscript{†}}
\author[\KISPIIMM]{Maarja Soomann \textsuperscript{†}}
...
We focused on known \ac{iei} genes, sometimes called the ``\ac{pid} or Monogenic Inflammatory Bowel Disease genes'' \cite{poli_human_2025, lawless_panelapprex_2025, martin_panelapp_2019},
...
of \ac{iei} from the \ac{iuis}  expert committee is reported by \citet{poli_human_2025},
...
\noindent 
DL performed main analysis and wrote the manuscript.
