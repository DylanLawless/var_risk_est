...
ggsave(paste0("../images/plot_scenario_multi", scenario, "_quant_uncert_ci.pdf"), plot = p_quant, width = 9, height = 7)
...
out_file <-  paste0("../images/table_scenario_multi", scenario, "_quant_uncert_ci.tex")
